    ...
    <div id="content">
      <div className="row pt-2 pb-1">
        <div className="col-md-10 mx-auto">
          <TwoColPhotoText
            src="/assets/images/youth_rally_group_2019.jpg"
            alt="2019 campers"
            text="Each year the Youth Rally hosts roughly 200 campers ages 11-17 from all over the United States and beyond! Many of our campers grow up to become Youth Rally Counselors and/or find alternative means to support their Rally Community."
          />
         <TwoColTextImg
            colSize1={8}
            colSize2={4}
